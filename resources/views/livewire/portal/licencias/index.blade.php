                ...
                <div class="p-6 lg:p-8 bg-white dark:bg-gray-800 dark:bg-gradient-to-bl dark:from-gray-700/50 dark:via-transparent border-b border-gray-200 dark:border-gray-700">
                    ...
                    @else
                        <div class="mb-5 flex justify-between items-center">
                            <h3 class="text-2xl font-semibold text-gray-700 dark:text-gray-200">Historial de Licencias</h3>
                                            ...
                                            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                                ...
                                                <td class="py-4 px-6 whitespace-nowrap">
                                                    @if($licencia->Estado_Solicitud == 'Pendiente')
                                                        <button wire:click="confirmarCancelacion({{ $licencia->ID_Licencia }})" class="px-2 py-1 text-xs font-medium text-red-600 bg-red-100 rounded-md hover:bg-red-200 dark:bg-red-700 dark:text-red-100 dark:hover:bg-red-600">
                                                            Cancelar
                                                        </button>
                                                    @else
                                                        N/A
                        ...
                        @else
                            <p class="text-gray-600 dark:text-gray-400">No tienes licencias registradas por el momento.</p>
                        @endif
                    @endif
                </div>
            </div>
